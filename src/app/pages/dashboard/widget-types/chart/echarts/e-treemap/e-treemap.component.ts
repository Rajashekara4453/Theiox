...
@Component({
  selector: 'kl-e-treemap',
  templateUrl: './e-treemap.component.html',
  styleUrls: ['./e-treemap.component.scss']
})
export class ETreemapComponent implements OnInit {
  public options: any;
  public lagTime: Boolean = false;
  public diskdata: any = [
    {
      "value": 40,
      "name": "Accessibility",
